...
### Commands
  ...
  - r, run - Runs the run/test file in your project, which runs the current build of your project, or whatever the user decides to for.
      ...
      > Note for using build and run commands. It may cause problems due to not being in the projects direcotry. You can run the dev files manually instead and use the command 'jdev' to be in the projects directory.`

## no
There is no official distribution of this software. Just run jbuild and jrun 
